...
//==================================================
	public class MetaballsTable
	{
		// Edge Cut Array
		// ------------------------------
		public static int[][] edgeCut = new int[][]{
		new int[]{-1, -1, -1, -1, -1}, //0
		new int[]{ 0,  3, -1, -1, -1}, //3
		new int[]{ 0,  1, -1, -1, -1}, //1
		new int[]{ 3,  1, -1, -1, -1}, //2
		...
		// ------------------------------
		public static int[][] edgeOffsetInfo = new int[][]{
			new int[]{0,0,0},
			new int[]{1,0,1},
			new int[]{0,1,0},
			new int[]{0,0,1}
		...
		// EdgeToCompute Array
		// ------------------------------
		public static int[] edgeToCompute = new int[]{0,3,1,2,0,3,1,2,2,1,3,0,2,1,3,0};
		...
		// bit 2 : Y+1
		// bit 3 : Y-1
		public static byte[] neightborVoxel = new byte[]{0,10,9,3,5,15,12,6,6,12,12,5,3,9,10,0};
