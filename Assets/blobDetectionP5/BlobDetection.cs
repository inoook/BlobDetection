...
//==================================================
	public class BlobDetection : EdgeDetection
	{
		...
		public Action filterBlobMethod;
		// Temp
		...
		// Constructor
		//	--------------------------------------------
		public BlobDetection (int imgWidth, int imgHeight) : base(imgWidth, imgHeight)
		{
			//base(imgWidth, imgHeight);
		
			gridVisited = new bool[nbGridValue];
...
//public void computeBlobs(int[] pixels)
		public void computeBlobs (byte[] pixels)
		{
			// Image
			setImage (pixels);
